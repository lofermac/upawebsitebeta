...
import { getContactLinks, type ContactLink } from "@/lib/supabase/contact";
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {isLoading ? (
                  ...
                  Array.from({ length: 3 }).map((_, index) => (
                    <div key={`skeleton-${index}`} className="relative rounded-2xl overflow-hidden animate-pulse">
                      <div className="relative border border-white/[0.08] rounded-2xl p-5 bg-black/40 backdrop-blur-sm">
                        <div className="w-11 h-11 rounded-xl bg-gray-800 mb-3"></div>
                  ...
                  contactLinks.map((link) => {
                    ...
                    return (
                      ...
                      >
                        {/* Background gradient */}
                        <div className={`absolute inset-0 bg-gradient-to-br ${config.color} opacity-10 group-hover/method:opacity-20 transition-all duration-500`}></div>
                        
                        {/* Border */}
                        <div className={`relative border border-white/[0.08] rounded-2xl p-5 bg-black/40 backdrop-blur-sm shadow-xl ${config.hoverColor} transition-all duration-500`}>
                          {/* Icon */}
                          <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${config.color} flex items-center justify-center mb-3 shadow-lg transition-all duration-500 group-hover/method:scale-110`}>
                  ...
                  <div className="col-span-3 text-center py-8">
                    <p className="text-gray-400">Contact methods not available</p>
                  </div>
                )}
              </div>
