...
export default function NewArticlePage() {
  ...
  const handleFeaturedImageUpload = async (file: File) => {
    ...
    try {
      ...
      successMsg.className = 'fixed top-24 right-8 z-50 p-4 bg-green-500/10 border border-green-500/20 rounded-lg flex items-center gap-3';
      successMsg.innerHTML = '<svg class="w-5 h-5 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4"/></svg><p class="text-green-400 text-sm">Image uploaded successfully!</p>';
